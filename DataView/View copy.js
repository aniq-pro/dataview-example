export class View{
    ...
    Config(Options = {}){
        ...
        this.#gridColumns = Options.gridColumns || 'auto';
        this.#gridItemWidth = Options.gridItemWidth || 200;
    ...
    #autoSetGridColumns(){
        let gridContainerWidth = this.#gridContainer.offsetWidth 
        console.log(this.#gridContainer.getBoundingClientRect().width);
        let gridNumItems = Math.floor(gridContainerWidth / this.#gridItemWidth);
        let gridItemWidth = (gridContainerWidth - (gridNumItems - 1) * 20) / gridNumItems; 
        this.#gridContainer.style.gridTemplateColumns = `repeat(${gridNumItems}, minmax( ${gridItemWidth}px, 1fr))`;
    }
